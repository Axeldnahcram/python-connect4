...
# -*- coding: utf-8 -*-
#
# This file is part of the python-connect4 library.
# Copyright (C) 2020-2020 Axel Marchand <axel-marchand@hotmail.fr>
#
...
setuptools.setup(
    ...
    version=connect4.__version__,
    author=connect4.__author__,
    author_email=connect4.__email__,
    long_description=read_description(),
    long_description_content_type="text/x-rst",
    license="GPL-3.0+",
    url="https://github.com/Axeldnahcram/python-connect4",
    packages=["connect4"],
    test_suite="test",
    python_requires=">=3.6",
